...
import {GOODBYE_KNOWN_CODES, GoodByeReasonCode, Libp2pEvent} from "../constants.js";
...
import {NodeId, computeNodeId, prettyPrintPeerId, prettyPrintPeerIdStr} from "../util/peerId.js";
import {getConnection, getConnectionsMap} from "../util.js";
...
/**
 * ReqResp methods used only be PeerManager for light client
 */
export interface IReqRespLightClientPeerManager {
...
export type PeerManagerModules = {
  ...
  libp2p: Libp2p;
  logger: LoggerNode;
  // Note: Light client doesn't use metrics
  reqResp: IReqRespLightClientPeerManager;
  gossip: Eth2Gossipsub;
  // TODO(light-client): Remove subnet services - light client doesn't need them
